            ...
            <div className="flex flex-col h-50 justify-evenly">
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div>
                        ...
                        <input type="text" name="Email" id="" className="border-2 border-[#6480c4] w-50" {...register("email")}/>
                    </div>
                    <div>
                    ...
                    <button type="submit" className="bg-[#2e3ed1] p-1 w-50 [clip-path:polygon(12px_0,100%_0,100%_calc(100%-12px),calc(100%-12px)_100%,0_100%,0_12px)] border-2 border-[#6480c4]">Signup</button>
                </form>
            </div>
